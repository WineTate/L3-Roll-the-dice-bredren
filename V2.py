...
while comp_score < game_goal and user_score < game_goal:
    ...
    comp_points = int(input("Enter the computer points at the end of round: "))
    user_points = int(input("Enter the user points at end of round"))
...
if user_score > comp_score:
    ...
    print("The computer won, HOW DID YOU LOSE, HOW ARE YOU THIS ELO AT A GAME")
